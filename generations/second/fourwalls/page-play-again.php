...
if (isset($wp_query->query_vars['one']) && $wp->query_vars['one'] != '') {
	if (isset($wp_query->query_vars['two'])) {
		...
		if ($event_query->post_count > 0) {
			...
			<div id="primary" class="play-again-primary content-area content-width">
				<div id="content" class="site-content play-again-page-event" role="main">
				<?php if ($query->have_posts()) : ?>

					<h1 class="entry-title event-category"><?php the_title(); ?></h1>
					<table>
	...
	<div id="primary" class="play-again-primary content-area content-width">
		<div id="content" class="site-content play-again-page" role="main">
		<?php if ($query->have_posts()) : ?>
