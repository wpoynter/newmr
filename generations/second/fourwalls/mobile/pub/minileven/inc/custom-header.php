		...
		<header id="branding" role="banner">
			<?php if ( 'blank' != $header_text ) : ?>
					<div class="site-branding">
						<h1 id="site-title"><span><a href="<?php echo esc_url( home_url( '/' ) ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home"><span style='color: #0166FF;'>New</span><span style='color: red;'>MR</span></a></span></h1>
